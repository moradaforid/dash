            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" placeholder="your@email.com" name="email" required autofocus autocomplete="username">
                    </div>
                    <div class="mb-2">
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\21265\Desktop\Projects\Dash - No Vuejs\resources\views/auth/login.blade.php ENDPATH**/ ?>