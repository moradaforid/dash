...
<?php $__env->startSection('pageTitle', isset($pageTitle) ? $pageTitle : 'Brands'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['name' => 'table_data','singularName' => 'Brand','crudPath' => ''.e(route('brand.index')).'','columns' => '[\'name\', \'domain\']','disabledSave' => '! (editRow.name && editRow.domain && editRow.logo && editRow.primary_color && editRow.secondary_color)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'table_data','singularName' => 'Brand','crudPath' => ''.e(route('brand.index')).'','columns' => '[\'name\', \'domain\']','disabledSave' => '! (editRow.name && editRow.domain && editRow.logo && editRow.primary_color && editRow.secondary_color)']); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\21265\Desktop\Projects\Dash - No Vuejs\resources\views/brand/index.blade.php ENDPATH**/ ?>