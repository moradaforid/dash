...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Welcome aboard to <?php echo e($mailData['name']); ?>! 🎉</p>
            ...
            <ul>
                <li>Name: <?php echo e($mailData['name']); ?></li>
                <li>Username:&nbsp;<?php echo e($mailData['username']); ?></li>
                <li>Password: <?php echo e($mailData['password']); ?></li>
                <li>URL : <?php echo e($mailData['url']); ?></li>
            </ul>
...
</html><?php /**PATH C:\Users\21265\Desktop\Projects\laravel-vue\resources\views/emails/test.blade.php ENDPATH**/ ?>