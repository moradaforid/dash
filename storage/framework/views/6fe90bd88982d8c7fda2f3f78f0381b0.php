...
<?php $__env->startSection('pageTitle', isset($pageTitle) ? $pageTitle : 'Service Providers'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['name' => 'table_data','singularName' => 'Provider','crudPath' => ''.e(route('service-provider.index')).'','columns' => '[\'name\', \'m3u schema\']','disabledSave' => '! (editRow.name && editRow.m3u_schema)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'table_data','singularName' => 'Provider','crudPath' => ''.e(route('service-provider.index')).'','columns' => '[\'name\', \'m3u schema\']','disabledSave' => '! (editRow.name && editRow.m3u_schema)']); ?>

             <?php $__env->slot('tableRows', null, []); ?> 
                <td x-text="row.name" class="px-4 py-3 text-sm font-semibold"></td>
                <td x-text="row.m3u_schema" class="px-4 py-3 text-sm font-semibold"></td>
             ...
             <?php $__env->slot('modalInputs', null, []); ?> 
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 py-6">
                    <label class="w-full block text-sm space-y-2">
                        ...
                        <span class="text-gray-700 dark:text-gray-400">M3u schema</span>
                        <input x-model="editRow.m3u_schema" require="" class="w-full p-2 text-sm text-gray-700 placeholder-gray-50 bg-gray-50 border border-gray-300 dark:border-gray-400 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input" placeholder="">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\21265\Desktop\Projects\Dash - No Vuejs\resources\views/service-provider/index.blade.php ENDPATH**/ ?>