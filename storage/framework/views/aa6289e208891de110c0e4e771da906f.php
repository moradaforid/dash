<?php $__env->startSection('pageTitle', isset($pageTitle) ? $pageTitle : 'Edit Profile'); ?>
        ...
        <div class="row row-cards">
            ...
            <div class="col-lg-12">
                <div class="row row-cards">
                    ...
                    <div class="col-12">
                        <form id="send-verification" method="post" action="<?php echo e(route('profile.update')); ?>" class="card">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <div class="row row-cards">
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <input class="form-control" placeholder="Your Name" name="name" value="<?php echo e($user->name); ?>">
                                    </div>

                                    <div class="mb-3 col-6">
                                        <label class="form-label">Email-Address</label>
                                        <input class="form-control" placeholder="your-email@domain.com" name="email" value="<?php echo e($user->email); ?>">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="row row-cards">
                    ...
                    <div class="col-12">
                        <form method="post" action="<?php echo e(route('password.update')); ?>" class="card">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\21265\Desktop\Projects\laravel-vue\resources\views/profile/edit.blade.php ENDPATH**/ ?>