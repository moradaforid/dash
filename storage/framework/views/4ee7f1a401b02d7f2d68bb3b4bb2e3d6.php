...
<?php $__env->startSection('pageTitle', isset($pageTitle) ? $pageTitle : 'Offer'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['name' => 'table_data','singularName' => 'Offer','crudPath' => ''.e(route('offer.index')).'','columns' => '[\'name\',\'sponsor\',\'status\', \'created at\']','disabledSave' => '!editRow.name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'table_data','singularName' => 'Offer','crudPath' => ''.e(route('offer.index')).'','columns' => '[\'name\',\'sponsor\',\'status\', \'created at\']','disabledSave' => '!editRow.name']); ?>
                ...
                <script>
                    function offerManager() {
                        ...
                        return {
                            ...
                            isLoading: false,
                            sponsors: <?php echo json_encode($sponsors, 15, 512) ?>,
                            sponsor: {},
                            testoo: [1, 2],
                            init() {
                                // sponsors
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\21265\Desktop\Projects\laravel-vue\resources\views/offer/index.blade.php ENDPATH**/ ?>