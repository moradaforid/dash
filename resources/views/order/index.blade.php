...
<main class="h-full overflow-y-auto">
    <div x-data="modal()" class="container px-6 mx-auto grid">
        ...
        <x-table name="table_data" singularName="Order" crudPath="{{ route('order.index') }}" columns="['guest id', 'email', 'amount', 'status']" disabledSave="! (editRow.email && editRow.guest_id && editRow.amount && editRow.payment_gateway_id && editRow.payment_order_id && editRow.status)">
