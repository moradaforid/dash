<!DOCTYPE html>
<html :class="{ 'dark': $store.dark.on }" x-data="data()" lang="en">

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Dashboard - Ad4o</title>
...
<body x-data="report()" x-init="$store.token = '{{ csrf_token() }}'">


    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': $store.is_main_menu_open.on }">
        <!-- Desktop sidebar -->
        ...
        <!-- Mobile sidebar -->
        <!-- Backdrop -->
        <div x-show="$store.is_main_menu_open.on" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 z-10 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center"></div>
        <aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden" x-show="$store.is_main_menu_open.on" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="$store.is_main_menu_open.on = false" @keydown.escape="$store.is_main_menu_open.on = false">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
                    Ad4o
                </a>
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        <!-- Card -->
                        <div class="flex items-center border border-gray-200 dark:border-gray-700 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <!-- New Table -->
                    <div class="w-full border border-gray-200 dark:border-gray-700 overflow-hidden rounded-lg shadow-xs" x-data='{ users: @json($users) }'>
                                    ...
                                    <template x-for="user in users">
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-xs">
                                                ...
                                                <template x-if="user.roles[0]['name'] == 'admin'">
                                                ...
                                                <template x-if="user.roles[0]['name'] == 'publisher'">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-blue-500 bg-blue-100 rounded-full dark:bg-blue-500 dark:text-blue-100">Publisher</span>
                                                </template>

                                                <template x-if="user.roles[0]['name'] == 'pending'">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100">Pending</span>
                                                </template>

                                            </td>
                                            <td class="px-4 py-3 text-sm" x-text="user.created_at"></td>
                    ...
                    <form @submit.prevent="$store.report.updateData()" x-init="$watch('$store.report.form.group', value => console.log(value))" class="flex flex-col flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
                        ...
                        <ul class="flex flex-col sm:flex-row">
                            ...
                            <li class="inline-flex items-center gap-x-2.5 py-2.5 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                <div class="relative flex items-start w-full">
                                    <div class="flex items-center h-5">
                                        <input x-model="$store.report.form.group" value="adunits" id="hs-horizontal-list-group-item-radio-2" name="hs-horizontal-list-group-item-radio" type="radio" class="border-gray-200 rounded-full dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
                                    </div>
                            ...
                            <li class="inline-flex items-center gap-x-2.5 py-2.5 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                <div class="relative flex items-start w-full">
                                    <div class="flex items-center h-5">
                                        <input x-model="$store.report.form.group" value="days" id="hs-horizontal-list-group-item-radio-3" name="hs-horizontal-list-group-item-radio" type="radio" class="border-gray-200 rounded-full dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
                                    </div>
                    ...
                    <!-- New Table -->
                    <div x-show="!$store.report.loading" class="w-full border border-gray-200 dark:border-gray-700 overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    ...
                                    <template x-for="adunit in $store.report.adunits">
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            <td class="px-4 py-3">
                                                <div class="flex items-center text-sm">
                                                    <div>
                                                        <p class="font-semibold" x-text="adunit.name"></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3 text-sm" x-text="adunit.impressions"></td>
                                            <td class="px-4 py-3 text-xs">

                                                <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100" x-text="adunit.clicks"></span>


                                            </td>
                                            <td class="px-4 py-3 text-sm" x-text="adunit.ctr"></td>
                                            <td class="px-4 py-3 text-sm" x-text="adunit.revenue"></td>
                    ...
                    <table id="example" class="w-full whitespace-no-wrap border border-gray-200 dark:border-gray-700 overflow-hidden overflow-x-auto rounded-lg shadow-xs" aria-describedby="example_info" x-show="!$store.report.loading">
                        <thead>
                            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                <th class="sorting sorting_asc px-4 py-3" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 133.4px;">Name</th>
                                <th class="sorting px-4 py-3" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 221.575px;">Position</th>
                                <th class="sorting px-4 py-3" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 98.75px;">Office</th>
                                <th class="sorting px-4 py-3" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 40.0125px;">Age</th>
                                <th class="sorting px-4 py-3" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 87.175px;">Start date</th>
                                <th class="sorting px-4 py-3" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 74.7625px;">Salary</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3 text-sm font-semibold">Mario Banner</td>
                    ...
                    <!-- New Table -->
                    <div x-show="!report.loading" class="w-full border border-gray-200 dark:border-gray-700 overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    ...
                                    <template x-for="adunit in report.data">
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            <td class="px-4 py-3">
                                                <div class="flex items-center text-sm">
                                                    <div>
    ...
    document.addEventListener('alpine:init', async () => {
        ...
        Alpine.store('report', {
            ...
            init() {
                ...
                let startDate = rangeDate.split('  To  ')[0];
                let endDate = rangeDate.split('  To  ')[1];

                this.getAdunits(startDate, endDate);
            },
            test: '', //this.getAdunits('2023-06-01', '2023-06-24'),
            adunits: [],
            apps: [],
            days: [],
            token: '{{ csrf_token() }}',
            ...
            getAdunits(startDate, endDate) {
                fetch('/report', {
                    ...
                    .then((data) => this.updateAdunitsTable(data))
