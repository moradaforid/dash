...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Service Providers')
@section('content')
...
<main class="h-full overflow-y-auto">
    <div x-data="modal()" class="container px-6 mx-auto grid">
        ...
        <x-table name="table_data" singularName="Provider" crudPath="{{ route('service-provider.index') }}" columns="['name', 'm3u schema']" disabledSave="! (editRow.name && editRow.m3u_schema)">
