...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Edit App')
@section('content')
        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-lg-12">
                    <div class="row row-cards">
                        <div class="col-12">
                            <form action="/apps/{{ $app->id }}" method="POST" class="card">
                                @csrf
                                @method("PATCH")
                                <div class="card-body">
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="Name" value="{{ $app->name }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Category</label>
                                                <input type="text" class="form-control" name="category_id" placeholder="Category" value="{{ $app->category_id }}">
                                            </div>
                                        </div>
            ...
            <x-table name="table_data" editType="modal" path="{{ route('category.index') }}" />
        </div>
    </div>
