...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Payment Gateways')
@section('content')
...
<main class="h-full overflow-y-auto">
    <div x-data="modal()" class="container px-6 mx-auto grid">
        ...
        <x-table name="table_data" singularName="Payment Gateway" crudPath="{{ route('payment-gateway.index') }}" columns="['name', 'Payment company', 'status']" disabledSave="! (editRow.name && editRow.api_key && editRow.payment_company && editRow.status)">
