...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Tests')
@section('content')
...
<main class="h-full overflow-y-auto">
    <div x-data="modal()" class="container px-6 mx-auto grid">
        ...
        <x-table name="table_data" singularName="Test" crudPath="{{ route('test.index') }}" columns="['username', 'password', 'service_provider_id', 'status']" disabledSave="! (editRow.username && editRow.password)">
