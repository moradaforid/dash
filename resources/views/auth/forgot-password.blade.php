...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Reset Your Password')
@section('content')
        ...
        <form class="card card-md" method="POST" action="{{ route('password.email') }}">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="Enter email" name="email" required autofocus>
