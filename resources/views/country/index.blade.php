...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Country')
@section('content')
...
<main class="h-full overflow-y-auto">
    <div x-data="modal()" class="container px-6 mx-auto grid">
        ...
        <x-table name="table_data" singularName="Country" crudPath="{{ route('country.index') }}" columns="['name', 'created at']" disabledSave="!editRow.name">
